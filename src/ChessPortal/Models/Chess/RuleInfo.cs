...
namespace ChessPortal.Models.Chess
{
    public static class RuleInfo
    {
        public static Dictionary<Piece, Direction[]> ValidDirections = new Dictionary<Piece, Direction[]>
        {
            ...
            {Piece.Knight, new [] {Direction.Eastnortheast, Direction.Northnorthwest, Direction.Southsoutheast, Direction.Southsouthwest, Direction.Westnorthwest, Direction.Westsouthwest, Direction.Northnortheast, Direction.Eastsoutheast}},
